...
const Home = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gold py-12 md:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-8 lg:mb-0 text-white text-center lg:text-left">
              ...
              <Link
                to="/shop"
                className="inline-flex items-center bg-gold text-gray-900 px-6 md:px-8 py-3 rounded-full font-semibold hover:bg-yellow-500 transition shadow-lg"
              >
                Shop Collection
      ...
      {/* Perfume Scents Grid */}
      <section className="py-12 md:py-16 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/10 dark:to-pink-900/10">
        <div className="container mx-auto px-4">
      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-r from-gold to-bronze rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-12 text-center text-white">
            ...
            <Link
              to="/shop"
              className="inline-block bg-white text-gray-900 px-6 md:px-8 py-3 rounded-full font-semibold hover:bg-gray-100 transition shadow-lg"
            >
              Shop Now
            </Link>
          </div>
