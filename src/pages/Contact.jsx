...
//   const faqs = [
//     { question: 'What is your return policy?', answer: 'We offer a 30-day return policy for all items in original condition.' },
//     { question: 'How long does shipping take?', answer: 'Standard shipping takes 3-5 business days. Express shipping is 1-2 business days.' },
...
//                 <button
//                   type="submit"
//                   className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition flex items-center justify-center"
//                 >
//                   <Send className="w-5 h-5 mr-2" />
//                   Send Message
//                 </button>
...
//                   <p className="text-sm text-gray-500 mt-1">(Replace with actual map integration)</p>
//                 </div>
//               </div>
//               <div className="p-6">
...
//                 <p className="text-gray-500 text-sm mt-1">Parking available in the building garage</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//               className="inline-flex items-center justify-center bg-white text-blue-600 px-6 py-3 rounded-lg hover:bg-gray-50 transition border border-blue-600"
//             >
//               <Mail className="w-5 h-5 mr-2" />
//               Email Support
//             </a>
